...
def get_config():
    ...
    if _config is None:
        ...
        if _config is None or not isinstance(_config, dict):
            _config = {}

        _apply_config_defaults(_config)
        ...
        if env_token:
            if env_token not in _config["auth_tokens"]:
                _config["auth_tokens"].append(env_token)
